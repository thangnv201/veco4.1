...
Redmine::Plugin.register :redmine_issue_evm do
  ...
  class RedmineIssueEvmHookListener < Redmine::Hook::ViewListener
    ...
    #@project_evm = EvmsController.getProjectEvm
    render_on :view_projects_show_left, :partial => 'redmine_issue_evm/statistic'
    render_on :my_page_statistic, :partial => 'redmine_issue_evm/mypage'
  end
