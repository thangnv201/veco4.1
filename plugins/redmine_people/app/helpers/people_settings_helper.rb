...
module PeopleSettingsHelper
  def people_settings_tabs
    ...
    tabs << { name: 'leave_types', partial: 'leave_types', label: :label_people_leave_types }

    if RedminePeople.use_announcements?
      tabs << { name: 'people_announcements', partial: 'announcements', label: :label_announcement_plural }
    end
