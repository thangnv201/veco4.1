...
resources :people do
  collection do
    ...
    get 'reports/:report', to: 'people_reports#show', as: 'people_reports'
  end
  ...
  resources :work_experience, except: [:index, :show], controller: :people_work_experiences
end
...
resources :people_announcements do
  collection do
    post :preview
    get :active
  end
...
resources :leave_types, except: [:index, :show]
resources :dayoffs, except: :show

match 'auto_completes/people_users' => 'auto_completes#people_users', via: :get, as: 'people_auto_complete_users'
