...
class ProductsIssuesControllerTest < ActionController::TestCase
  ...
  def test_autocomplete_for_product
    ...
    compatible_xhr_request :get, :autocomplete_for_product, :q => 'crm', :issue_id => '1', :project_id => 'ecookbook'
  ...
  def test_create_multiple
    @request.session[:user_id] = 1
    compatible_xhr_request :post, :add, :issue_id => '2', :products_issue => { :product_ids => ['3', '4'] }
    assert_response :success
